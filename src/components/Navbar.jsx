                ...
                <nav className="w-full px-6 py-4 flex items-center justify-between relative z-20">
                    ...
                    <div className="flex items-center gap-4">
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-3 border cursor-pointer border-gray-300 rounded-full text-xs font-medium tracking-wider text-gray-800 hover:bg-gray-100 transition-colors"
                        >
                            WATCH DEMO
                        ...
                        <button className="px-5 py-3 bg-[#2D5016] text-white rounded-full cursor-pointer text-xs font-medium tracking-wider hover:bg-[#234012] transition-colors">
                            START FOR FREE
                        </button>
                    </div>
                </nav>
